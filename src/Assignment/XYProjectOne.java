...
public class XYProjectOne {
    ...
    static void output (float age, float bl, float weight, String gender) {
        ...
        System.out.printf("For a citizen of gender type %s, who is %.0f cycles old and weighs %.0f kilograms with a reported Biximent Level of %.2f, the Biximent Metabolic Index is %.2f, their condition is %s and %s is recommended.\n", gender, age, weight, bl, BMI, condition, treatment);
